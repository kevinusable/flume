...
public class TestElasticSearchSink extends AbstractElasticSearchSinkTest {
  ...
  public void shouldIndexInvalidComplexJsonBody() throws Exception {
    ...
    assertSearch(1,
        performSearch(QueryBuilders.termQuery("@message", "TEST1")),
        null, event1);
    assertSearch(1,
        performSearch(QueryBuilders.termQuery("@message", "TEST2")),
        null, event2);
    assertSearch(1,
        performSearch(QueryBuilders.termQuery("@message", "TEST3")),
        null, event3);
  }
  ...
  public void shouldIndexComplexJsonEvent() throws Exception {
    ...
    assertSearch(1,
        performSearch(QueryBuilders.termQuery("@message.event", "json")),
        expectedBody, event);
  }
